                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                  color:
                                      llb ? Colors.transparent : g.blackfont2),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                  color:
                                      llm ? Colors.transparent : g.blackfont2),
                  ...
                  RawMaterialButton(
                    onPressed: () async {
                      if (_key.currentState.validate()) {
                        ...
                        g.attorney.ratePh = int.parse(clirate.text.trim());
                        g.attorney.username = cliusername.text.trim();
                        setState(() {
                          DBServices().updateattorney(g.attorney).then((value) {
                            if (value is String) {
